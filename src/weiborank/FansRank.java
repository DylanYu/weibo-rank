...
public class FansRank extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		JobConf conf = new JobConf(getConf(), FansRank.class);
...
//		FileInputFormat.setInputPaths(conf,"C:/Yu/weibo_test");
		FileInputFormat.setInputPaths(conf,"C:/workspace/weiborank/weibo_data");
//		FileOutputFormat.setOutputPath(conf, new Path("counter"));
		...
		JobConf sortJob = new JobConf(getConf(), FansRank.class);
...
//		sortJob.setInputFormat(TextInputFormat.class);
	...
	public static void main(String[] args) throws Exception {
		int ret = ToolRunner.run(new FansRank(), args);
	}
}